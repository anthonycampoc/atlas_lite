<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
      ...
      <li class="nav-item">
          <a class="nav-link" target="_blank" href="https://wa.me/message/FL47JDKOWOTVH1">
            <i class="fab fa-whatsapp-square menu-icon"></i>
              <span class="menu-title">Servicio Tecnico</span>
          </a>
      </li>
  </ul>
</nav>