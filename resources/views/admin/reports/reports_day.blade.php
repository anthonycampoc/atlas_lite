                    ...
                    <div class="row ">
                        <div class="col-12 col-md-4 text-center">
                            ...
                            <div class="form-group">
                                <strong>{{\Carbon\Carbon::now('America/Guayaquil')->format('d/m/Y')}}</strong>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 50px;">
                                        ...
                                        <a href="{{route('sales.show', $sale->id)}}" class="jsgrid-button jsgrid-edit-button"><i class="far fa-eye"></i></a>
