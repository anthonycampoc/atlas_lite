            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="cmxform" id="signupForm" method="POST"   action="{{action('ProviderController@update', $provider->id)}}">
                  {{csrf_field()}}
                  @method('PUT')
                    <fieldset>
                      <div class="form-group">
                        <label for="name">Nombre</label>
                        <input id="name" class="form-control form-control-lg" name="name" type="text" value="{{$provider->name}}">
                      </div>
                      <div class="form-group">
                        <label for="email">Correo</label>
                        <input id="email" class="form-control form-control-lg" name="email" type="email" value="{{$provider->email}}">
                      </div>
                      <div class="form-group">
                        <label for="ruc">Ruc</label>
                        <input id="ruc" class="form-control form-control-lg" name="ruc" type="text" value="{{$provider->ruc}}">
                      </div>
                      <div class="form-group">
                        <label for="address">Direccion</label>
                        <input id="address" class="form-control form-control-lg" name="address" type="text" value="{{$provider->address}}">
                      </div>
                      <div class="form-group">
                        <label for="phone">Telefono</label>
                        <input id="phone" class="form-control form-control-lg" name="phone" type="text" value="{{$provider->phone}}">
                      </div>
