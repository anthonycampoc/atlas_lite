<div class="form-row">
    <div class="form-group col-md-8">
        <div class="form-group">
            ...
            <select class="form-control form-control-lg" name="provider_id" id="provider_id">
    ...
    <div class="form-group col-md-4">
        ...
        <div class="input-group">
            ...
            <?php
                $tax = 12;
            ?>
            <input type="number" class="form-control form-control-lg" name="tax" id="tax" aria-describedby="basic-addon3"
                placeholder="12" value="<?php echo $tax; ?>" disabled>
        </div>
    </div>
</div>
...
<div class="form-row">
    <div class="form-group col-md-6">
        <div class="form-group">
            ...
            <!-- <select class="form-control form-control-lg selectpicker" data-live-search="true" name="product_id" id="product_id"> -->
    ...
    <div class="form-group col-md-2">
        <div class="form-group">
            ...
            <input type="number" class="form-control form-control-lg" name="price" id="price" aria-describedby="helpId">
        </div>
    </div>
</div>
